...
if ( false !== $_REQUEST['updated'] ) : ?>
            <div>
                <p><strong><?php __( 'Options saved' ); ?></strong></p>
            </div>
            <?php endif; ?>
...
$theme_name = $pg_theme->get( 'Name' );?>
                ...
                <div class="card mb-3">
                    ...
                    <div class="input-group mb-1">
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon1"><?php _e( 'Custom CSS File URL' ); ?></span>

                        </div>
                        <input id="theme_settings[customcss]" class="form-control" type="text" size="36" name="theme_settings[customcss]" value="<?php esc_attr_e( $options['customcss'] ); ?>" />
                    </div>
                    <div class="small mb-3"><a href="https://pikock.github.io/bootstrap-magic/app/index.html#!/editor" target="_blank">Click here to generate a custom stylesheet using Bootstrap Magic.</a> </div>
                    <div class="input-group mb-3">
                        <div class="input-group-prepend">
