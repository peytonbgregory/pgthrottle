...
require_once get_template_directory() . '/includes/post-type-work.php';
...
function pgthrottle_scripts() {
	...
	wp_register_script( 'bootstrap-js', THEME_DIR . '/js/pgthrottle.js', 'jquery', '', true );

	wp_enqueue_style( array('google-font','pgthrottle-css','theme-css'));
	wp_enqueue_script(array('jquery','theme-js')); 
}
