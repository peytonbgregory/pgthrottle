...
<?php if(!empty($options['facebook_url']) || !empty($options['linkedin_url']) || !empty($options['google_plus_url']) || !empty($options['youtube_url']) || !empty($options['instagram_url']) || !empty($options['pinterest_url']) ){ ?>
