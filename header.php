...
<body <?php body_class($pgbodyclass); ?>>
    ...
    <div id="site-wrapper">
        ...
        <header class="<?php echo $pgheaderclass ?>" id="site-header" role="banner">
            ...
            <nav class="navbar <?php echo $pgnavclass ?> navbar-expand-lg navbar-light bg-light" role="navigation" id="site-navigation">
    ...
    if ( has_post_thumbnail( $page_id ) ) :
        ...
        <section class="feature-header mb-5" style="background:url('<?php echo $image; ?>')" role="banner">
